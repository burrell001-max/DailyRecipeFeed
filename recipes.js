const recipeCatalog = [
    ...
    },
    {
        ...
        directions: ["Whisk soy sauce, brown sugar, ginger, and garlic in a small bowl.", "Sear steak strips in a hot skillet with oil for 2-3 minutes until browned; set aside.", "Add broccoli to the same skillet with a vanilla splash of water; steam for 3 minutes.", "Return beef to pan, pour in sauce, and toss over high heat until sticky and bubbling."]
    },
    {
        id: "chicken-alfredo",
    ...
    },
    {
        ...
        reviews: "196",
        description: "Breaded, pan-fried chicken cutlets baked under a rich blanket of marinara sauce and molten fresh mozzarella cheese.",
    ...
    },
    {
        ...
        ingredients: ["3 russet potatoes, peeled and diced", "2 large leeks, white and light green parts sliced", "3 tbsp unsalted butter", "4 cups vegetable broth", "1/2 cup heavy cream", "Salt and pepper to taste"],
        directions: ["Melt butter in a large pot and sauté the sliced leeks until soft and translucent.", "Add the diced potatoes and vegetable broth; bring to a boil.", "Reduce heat, cover, and simmer for 20 minutes until the potatoes are completely tender.", "Puree with an immersion blender until completely smooth, stir in heavy cream, and season with salt and pepper."]
    }
];
